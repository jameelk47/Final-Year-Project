...
# XGBoost can handle sparse matrices natively, but we'll convert to dense for consistency
...
# 5. K-fold cross-validation on full pipeline (preprocessing + XGBoost)
